...
const translations = {
  en: {
    ...
    orchestra: "Orchestra",
    piano: "Piano",
    drawing: "Caricature Drawing",
    booking: "Booking",
    animation: "Animation",
    flags: "Flags",
    drums: "Drums",
    violinOud: "Violin and Oud",
    melodica: "Melodica",
  ...
  ar: {
    ...
    piano: "البيانو",
    drawing: "الرسم الكاريكاتوري",
    booking: "الحجز",
    animation: "الرسوم المتحركة",
    flags: "الأعلام",
    drums: "الطبول",
    violinOud: "الكمان والعود",
    melodica: "الميلوديكا",
